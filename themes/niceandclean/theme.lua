...
-- set wallpaper, evaluating these in order
wp_script_1 = themedir .. "/niceandclean.sh"
wp_script_2 = home .. "/.wallpaper"
wallpaper1 = themedir .. "resolutions/default/background.jpg"
wallpaper2 = themedir .. "resolutions/default/background.png"
wallpaper3 = sharedthemes .. "/zenburn/zenburn-background.png"
wallpaper4 = sharedthemes .. "/default/background.png"

if awful.util.file_readable(wp_script_1) then
    theme.wallpaper_cmd = { "sh " .. wp_script_1 }
elseif awful.util.file_readable(wp_script_2) then
    theme.wallpaper_cmd = { "sh " .. wp_script_2 }
...
wp_image = themedir .. "/resolutions/default/background.jpg"
if awful.util.file_readable(wp_image) then
    theme.wallpaper = wp_image
end
...
theme.menu_submenu_icon = themedir .. "/imgs/submenu.png"
...
theme.awesome_icon = themedir .. "/imgs/awesome16.png"
