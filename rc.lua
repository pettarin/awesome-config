...
globalkeys = awful.util.table.join(
    ...
    awful.key({ "Control",        }, "Escape",  function () awful.util.spawn(".bin/advancedOSD toggleVolume")   end),
    awful.key({ "Control",        }, "F1",      function () awful.util.spawn(".bin/advancedOSD lowerVolume")    end),
    awful.key({ "Control",        }, "F2",      function () awful.util.spawn(".bin/advancedOSD raiseVolume")    end),
    awful.key({ "Control",        }, "F3",      function () awful.util.spawn(".bin/advancedOSD toggleCapture")  end),
    awful.key({ "Control",        }, "F5",      function () awful.util.spawn(".bin/advancedOSD toggleRadio")    end),
    awful.key({ "Control",        }, "F6",      function () awful.util.spawn(".bin/advancedOSD webcam")         end),
    awful.key({ "Control",        }, "F7",      function () awful.util.spawn("lxrandr")                         end),
    awful.key({ "Control",        }, "F8",      function () awful.util.spawn(".bin/advancedOSD toggleTouchpad") end),
    awful.key({ "Control",        }, "Insert",  function () awful.util.spawn(".bin/advancedOSD screenshot")     end),
...
awful.rules.rules = {
    ...
    {
        -- Icedove (Thunderbird) always on desktop #1
        rule = {
            class = "Icedove"
        },
        properties = {
